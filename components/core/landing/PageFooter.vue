<template>
  <footer class="bg-gray-800">
    ...
    <div class="container px-6 pt-10 pb-6 mx-auto">
      ...
      >
        <div
          class="flex items-center justify-center w-10 h-10 p-2 mx-5 bg-gray-300 rounded-full shadow-2xl group hover:bg-gray-100"
        >
          <a
            href="https://web.facebook.com/escolatecnicadomindeloGDC"
            target="_blank"
            class="flex items-center justify-center group group-hover:text-gray-700 "
          >
            <fa
              class="text-xl group-hover:text-primary "
              :icon="['fab', 'facebook-f']"
            />
          </a>
        </div>
        ...
        >
          <a
            href="#"
            class="flex items-center justify-center group-hover:text-gray-700 "
          >
            <fa
              class="text-xl group-hover:text-primary "
              :icon="['fab', 'twitter']"
            ...
            <li class="mt-2">
              ...
              >
                <span>
                  ...
                  Cabo Verde, São Vicente, Mindelo</span
                >
              </a>
            </li>
          </ul>
